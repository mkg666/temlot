...
if __name__ == "__main__":
    ...
    # sql = "select Number_02, Temperature, String_01, Humidity, Identity, Timestamp, Distance, deviceName from metric"
    # timestamp = int(time.time())
...
def select(sql):
    ...
    result = TsdbClient(tsdb_sample_conf.config).get_rows_with_sql(sql)
    return result.rows
